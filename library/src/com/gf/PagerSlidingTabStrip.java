...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean applyTabStates = true;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabIconSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, tabIconSize, dm);
        ...
        tabIconSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIconSize, tabIconSize);
        tabIconColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabIconColor, tabIconColor);
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabTextColor, tabTextColor);
        applyTabStates = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsApplyTabStates, applyTabStates);
    ...
    private void addIconTab(final int position, int resId) {
        addIconTab(position, getContext().getResources().getDrawable(resId));
    }

    private void addIconTab(final int position, Drawable res) {
        res.setColorFilter(tabIconColor, PorterDuff.Mode.SRC_IN);
        FrameLayout tab = new FrameLayout(getContext());
        ImageView ib = new ImageView(getContext());
        LayoutParams lp = new LayoutParams(tabIconSize, tabIconSize);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                ((ImageView) ((FrameLayout) v).getChildAt(0)).getDrawable().setColorFilter(tabIconColor, PorterDuff.Mode.SRC_IN);
            }
    ...
    public void setIconColor(int tabIconColor) {
    ...
    public boolean isApplyTabStates() {
        return applyTabStates;
    }

    public void setApplyTabStates(boolean applyTabStates) {
        this.applyTabStates = applyTabStates;
        updateTabStyles();
    }
